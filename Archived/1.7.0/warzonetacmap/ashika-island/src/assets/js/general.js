...
async function main() {
	...
	const iconArray = [
		...
		{name: "safe", fileName: "icon-safe", iconSize: [26, 26], iconAnchor: [23, 23],popupAnchor: [0, -26]},
		{name: "game_machine", fileName: "icon-game-machine", iconAnchor: [15, 30], opupAnchor: [0, -30]},
		{name: "gpu", fileName: "icon-gpu", conSize: [10, 10],iconAnchor: [5, 5],popupAnchor: [0, -10]},
		...
		{name: "blow_torch", fileName: "icon-blow-torch", iconSize: [10, 10], iconAnchor: [5, 5], popupAnchor: [0, -10]},
		{name: "zipline", fileName: "icon-zipline", iconSize: [30, 30],iconAnchor: [15, 15], popupAnchor: [0, -15]},
		{name: "zipline_down", fileName: "icon-zipline-down", iconSize: [30, 30],iconAnchor: [15, 15], popupAnchor: [0, -15]},
	]
	...
	iconArray.forEach(item => {
		$icon[item.name] = _createCustomIcon(item)
	})
	//////////////////// icons end
